...
//        Paragraph name = new Paragraph("이름: " + dto.getName(), normalFont);
...
//    }
//
//    private void drawScoreBar(PdfContentByte canvas, float x, float y, ScoreInfo info) {
//        float maxWidth = 100f;
//        float filledWidth = (info.score / info.maxScore) * maxWidth;
//
//        Color fillColor;
//        float ratio = info.score / info.maxScore;
...
//        canvas.setColorFill(Color.BLACK);
//        canvas.showTextAligned(PdfContentByte.ALIGN_LEFT, info.label, x, y + 12, 0);
//        canvas.showTextAligned(PdfContentByte.ALIGN_LEFT, info.score + "/" + info.maxScore, x + 160, y + 2, 0);
//        canvas.showTextAligned(PdfContentByte.ALIGN_LEFT, "- " + info.explanation, x, y - 10, 0);
//        canvas.endText();
//    }
//
//
